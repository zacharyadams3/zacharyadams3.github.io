(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.db, 450, 600, -10, 1);
        collectable.create(type.grace, 800, 450, 7, 0.9);
        collectable.create(type.max, 850, 275, 8, 0.8);
        collectable.create(type.steve, 200, 170, 6, 0.7);
        collectable.create(type.kennedi, 800, 100, 10, 1);
        collectable.create(type.kennedi, 125, 50, 5, 0.9);
